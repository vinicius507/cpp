...
/*   Updated: 2023/05/25 17:35:17 by vgoncalv         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
  ...
  /**
   * @brief Calculates the absolute value of the fixed-point number.
   *
   * This method calculates the absolute value of the fixed-point number,
   * returning a new Fixed object with the absolute value. If the fixed-point
   * number is less than zero, the method uses two's complement to obtain the
   * absolute value.
   *
   * @return A new Fixed object representing the absolute value of the
   * fixed-point number.
   */
